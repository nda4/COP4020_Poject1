/*
    ...
    This catagory is then turned over to Parse for later processes. It also checks for common errors such as double underscores
    and returns those as well. <> represents a identity ~~ represents errors.
